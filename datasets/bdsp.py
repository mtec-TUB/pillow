...
class BDSP(BaseDataset):
    ...
    def _setup_dataset_config(self):
        ...
        # only for I0002
        self.channel_names = ['F3-M2', 'F4-M1', 'C3-M2', 'C4-M1', 'O1-M2', 'O2-M1', 'E1', 'E2', 'CHIN', 'SNORE', 'NPT', 'C-FLOW', 'CHEST', 'ABDOMINAL', 'LAT', 'RAT', 
        ...
        # only for I0002
        self.channel_types = {'analog': ['F3-M2', 'F4-M1', 'C3-M2', 'C4-M1', 'O1-M2', 'O2-M1', 'E1', 'E2', 'CHIN', 'SNORE', 'NPT', 'C-FLOW', 'CHEST', 'ABDOMINAL', 
        ...
        # only for I0002
        self.channel_groups = {'eeg_eog': ['F3-M2', 'F4-M1', 'C3-M2', 'C4-M1', 'O1-M2', 'O2-M1', 'E1', 'E2','F7-A2', 'F8-A1', 'T3-A2', 
