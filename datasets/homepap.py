...
class HOMEPAP(BaseDataset):
    ...
    def _setup_dataset_config(self):
        ...
        self.alias_mapping = {
                'abdomen': [ 'ABDOMEN', 'Abdomen','ABD','Abd'],
                'cannula': ['Cannulaflow', 'Cannula', 'CannlulaFlow', 'CannulaNasal','CannualFlow','Cannula Flow', 'CannulaFlow','CannulaFLow','Nasal Cannula'],
                ...
                'E1': ['E1-M2', 'E1-E2','E1', 'L-EOG','LOC'],
                'E2': ['E2-M1', 'E-2','E2', 'R-EOG','ROC'],
                'ECG': ['EKG', 'ECG', ],
                'ECG1':['EKG1','ECG I','ECG1',],
                'ECG2':['ECG2','EKG2','ECG II'],
                'ECG3':['EKG3','ecg3','ECG3'],
                'co2': ['EtCO2 #', 'EtCO2 Wave','TcCO2 #','TcCO2','ETCO2Wave', 'TCCO2#','ETCO2#','TCCO2',  'EtCO2'],
                'flow': ['AIRFLOW','Airflow','AirFlow','AIR-flow','FLOW','FLOW5','FLOW2','NPV flow'],
                'heartrate': ['HeartRate','Heart Rate','HR','HRate','DHR'],
                'leak': ['Leak', 'LEAK1','MaskLeak', 'LEAK'],
                'lleg': ['L-Legs', 'Lleg', 'LLeg', 'LLEG','L Leg', ],     
                'lleg_1': ['Lleg1','LLeg1','L-LEG1','LLEG1',],    
                'lleg_2': ['L-LEG2','LEG/L2','LLEG2','LLeg2','Lleg2'],
                'O1_M2': ['O1-M2'],
                'O2_M1': ['O2-M1'],
                'pap_flow': ['CFLOW', 'CPAPFLOW', 'XFlow','PAP Flow','MaskFlow', 'MaskFLow','Mask Flow', 'Mask', 'CPAPMask'],
                'pap_pres': ['xPAP CPAP', 'PAP', 'CPAPPressure', 'PAP Press', 'xPAP','CPAP'],
                'phase': [ 'Phase'],
                'pleth': ['PLeth','PLETH','TcCO2 Pleth', 'Pleth'],
                'position': ['Positiom','Body Position','BodyPosition', 'Position'],
                'pressure': ['Pressure', 'pressure','PressureE','PRESSURE1','PressureI'],
                'pulse': [ 'PULSE', 'Pulse'],
                'r_r': ['R-R', 'Resp Rate', 'RespRate', 'Resp'],
                'rleg': [ 'RLEG', 'RLeg', 'R Leg', 'R-Legs','Rleg'],
                'rleg_1': ['LEG/R1','RLEG1','RLeg1','Rleg1','R-LEG1'],
                'rleg_2': ['RLeg2','Rleg2', 'RLEG2','R-LEG2','LEG/R2', ],                
                'snore': ['SNORE Mic','SNORE', 'Snore','Snore Mic', 'Snore Sensor','CannulaSnore','SnoreSensor','SNORE mic','Cannula Snore','SNORE MIC 1'],
                'spo2': ['O2', 'SpO2','Ox', 'SPO2', 'SaO2', 'Sa02','SA02', 'SAO2'],
                'spostat': ['OXSTAT','Ox Status'],
                'therm': ['Thermistor'],
                'tvol': ['TidVol'],
                'xsum': ['XSum'],
                }
        ...
        self.channel_groups = {
            'eeg_eog': ['C3-M2', 'C3', 'C4', 'C4-M1', 'F2-M2', 'F3-M2', 'F3', 'F4-M1', 'F4', 'M1-M2', 'O1-M2', 'O2-M1',
