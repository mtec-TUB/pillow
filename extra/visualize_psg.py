...
# === CONFIG ===
file_path1 = "/home/linda/Downloads/Alias_tests/DOD-O_harmonized/npz/ECG/c03e27b0-4cb5-584f-aaea-8f1e1ed6513c.npz"
# file_path2 = "/media/linda/Elements/sleep_data/MIT-BIH - Polysomnographic Database/MIT-BIH_harmonized/npz/st___ECG/slp01a.npz"
# file_path3 = "/media/linda/Elements/sleep_data/MIT-BIH - Polysomnographic Database/MIT-BIH_harmonized/npz/slpdb_ECG/slp01a.npz"
...
for idx,file_path in enumerate([file_path1]):
    # ---------- LOAD ----------
    ...
    display_order = ["Unkown","Wake", "Movement","REM", "N1", "N2", "N3"]
    ...
    # ---------- PLOTTING ----------
    # Signal plot
    axes[0].plot(time, sig, lw=0.5, label=idx)
    ...
    # Hypnogram plot (step)
    axes[1].step(t_epochs, y_plot, where="post", lw=1.5, label=idx)
